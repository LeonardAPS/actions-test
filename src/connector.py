...
import requests,pysftp,datetime
...
class CallbiAPI(object):
    ...
    # def get_imports(self,upload_id):
    #     get_import_url = self.base_url + "/api/v2019-07-08/organizations/{}/uploads/{}/imports"
    #     return requests.get(get_import_url.format(self.organization,upload_id),headers = self.header)
    
        
         

# response = SFTP().connect()
# print(response)
